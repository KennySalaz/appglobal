    ...
    return (
        <>
            <div className="container-xl">
                    ...
                    <div className="row clearfix">
                        <div class="content-column col-sm-4 center_sFlex">
                            <div className="m-top-section inner-column ">
                                ...
                                <div className='p-flexB'>
                                    <a  href="mailto:sales@globalnet.us.com">
                ...
                <div className="button_flexx">
                    <a className="theme-btn btn-style-one respon_botton" href="mailto:sales@globalnet.us.com">
                        <span className="txt">
                    ...
                    <div className="text-p content-column col-lg-5 col-md-12 col-sm-12 ">
                        <div className="inner-column">
                            <div data-aos="fade-up">
                                ...
                                <span> con la finalidad de brindar asesoría en materia tecnológica </span>
                                ...
                                <div className="inner-column">
                                    <div className="sec-title config_respon-2">
                                        ...
                                        <div className="text" data-aos="fade-up" >
                                            <span > Nuestra amplia experiencia nos permite
