                        ...
                        <div className="col-xl-4">
                            ...
                            <div className="card">
                                <div className="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                    ...
                                    <img src={user.FotoUrl} alt="Profile" className="rounded-circle" />
                                    <h2>{user?.Nombre} </h2>
                                    <h3>{user?.Apellido}</h3>
                                    ...
                                    <div className="tab-content pt-2">
                                        ...
                                        <div className="tab-pane fade show active profile-overview" id="profile-overview">
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-lg-9 col-md-8"> {user.Nombre} {user.Apellido} </div>
                                            </div>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-lg-9 col-md-8">{user.Metodo} </div>
                                            </div>
